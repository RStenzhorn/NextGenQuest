...
@Service("weeklyQuestConsumer")
public class WeeklyQuestConsumer implements Consumer<InventoryClickEvent> {
    ...
    public void accept(final InventoryClickEvent event) {
        if (event.getWhoClicked() instanceof final Player player) {
            ...
            final List<QuestEntity> quests = questsByUuidIntervalTypeSupplier.apply(uuid, IntervalType.WEEKLY.name());
            final String inventoryName = messageSupplier.apply(NgqMessageType.INVENTORY_WEEKLY_QUESTS, locale);
